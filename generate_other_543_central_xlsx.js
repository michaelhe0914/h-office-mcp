// Generate styled XLSX: 114上 其它類別 — 中區各客戶
...
// Data aggregation
// =================================================================
const zoneRecords = allRecords.filter(r => r.zone === TARGET_ZONE);
...
const custProductData = aggregateByCustomerProduct(zoneRecords);
const allProductData = aggregateByProduct(zoneRecords);
...
async function main() {
  ...
  const outputPath = path.join(outputDir, '114上_其它類別_中區各客戶.xlsx');
